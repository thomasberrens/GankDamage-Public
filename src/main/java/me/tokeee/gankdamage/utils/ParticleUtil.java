...
import me.tokeee.gankdamage.particles.ParticleTrailBuilder;
...
public class ParticleUtil {
    ...
    public static void createParticleTrailForArrow(final Arrow arrow, final int red, final int green, final int blue, final Effect effect){
